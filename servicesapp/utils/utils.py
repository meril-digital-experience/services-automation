# from apps.servicesapp.servicesapp.utils.utils import custom_send_mail
# import frappe
# import random
...
#     if not engineer or not engineer.company_email:
#         return
...
#         "doc_name": doc.name,
#         "asset": doc.asset_no,
#         "date": doc.call_schedule_date,
#         "link": frappe.utils.get_url_to_form(doc.doctype, doc.name)
#     }

#     custom_send_mail(
#         mail_template="Installation Request Assignment",  # your Email Template name
